...
import { useWavesStore } from '../composables/useWavesStore'
...
const classes = computed(() => themeClasses(props.theme))
const { state: waves, waveOptions } = useWavesStore(props.amount)
...
.wave-fade-in.reverse:nth-child(9) {
  animation-delay: 0.3s;
}
.wave-fade-in.reverse:nth-child(8) {
  animation-delay: 0.4s;
}
.wave-fade-in.reverse:nth-child(7) {
  animation-delay: 0.5s;
}
.wave-fade-in.reverse:nth-child(6) {
  animation-delay: 0.6s;
}
.wave-fade-in.reverse:nth-child(5) {
  animation-delay: 0.7s;
}
.wave-fade-in.reverse:nth-child(4) {
  animation-delay: 0.8s;
}
.wave-fade-in.reverse:nth-child(3) {
  animation-delay: 0.9s;
}
.wave-fade-in.reverse:nth-child(2) {
  animation-delay: 1s;
}
.wave-fade-in.reverse:nth-child(1) {
  animation-delay: 1.1s;
}
.wave-fade-in.reverse:nth-child(0) {
  animation-delay: 1.2s;
}

.wave-fade-in:nth-child(3) {
  animation-delay: 0s;
}
.wave-fade-in:nth-child(2) {
  animation-delay: 0.1s;
}
.wave-fade-in:nth-child(1) {
