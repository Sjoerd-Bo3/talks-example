...
const themeColor = computed(() => (formatter.value.themeColor || 'blue') as string)
...
<template>
  <div>
    ...
    >
      <div
        class="clip bg-gradient-to-r from-blue to-white/10"
        :style="{ 'clip-path': `polygon(${poly1})`, 'opacity': opacity }"
      />
      <div
        class="clip bg-gradient-to-l from-light-blue to-white/10"
